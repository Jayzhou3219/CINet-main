...
class ZJL_GOAL(Base_Model):
    def __init__(self, args, device):
        ...
        trainable_params = sum(p.numel() for p in self.cross_atten.parameters() if p.requires_grad)
        print(f"{self.cross_atten}  has total {trainable_params} trainable params")
