...
class ZJL_GOAL_another(Base_Model):
    def __init__(self, args, device):
        ...
        self.goal_module = UNet(
            enc_chs=(self.num_image_channels + 20,
                     32, 32, 64, 64, 64),
    ...
    def forward(self, inputs, ground_truth, num_samples=1, if_test=False):
        ...
        for frame_idx in range(self.args.obs_length, self.args.obs_length + self.args.pred_length):
            ...
            input_goal_module = torch.cat((tensor_image, obs_traj_maps), dim=1)  # H_S
            ...
            fusion_transformer_out = fusion_transformer(additional_info_upper, mask=False)
