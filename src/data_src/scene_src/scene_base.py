...
class Scene_base(object):
    """
    The Scene class contains generic(通用的;一般的) scene information, mainly
    paths, homography matrix(单应矩阵), maps (RGB, semantic) etc...
    ...
    def __init__(self):
        ...
        self.path_to_root = "/home/zjl9/code/Human-Trajectory-Forecasting/"
